...
if __name__ == "__main__":
    ...
    distribution = (126090, 6730) # amt of cars, amt of trucks > data from bast.de

    sim = Simulation(model_params_list=[car_normal, truck_normal], distribution=distribution, delta_t=DELTA_T, car_frequency=1/1.6)
    data = sim.run(250)
